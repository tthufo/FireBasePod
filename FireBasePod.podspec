...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/tthufo@gmail.com/FireBasePod'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'tthufo@gmail.com' => 'tthufo' }
  s.source           = { :git => 'https://github.com/tthufo@gmail.com/FireBasePod.git', :tag => s.version.to_s }
  ...
  # s.resource_bundles = {
  #   'FireBasePod' => ['FireBasePod/Assets/*.png']
  # }
